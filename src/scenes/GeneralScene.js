// GeneralScene erbt von Phaser.Scene, die von Phaser kommt
class GeneralScene extends Phaser.Scene {
  constructor(key, config) {
    super(key);
    this.config = config; // this Kontext wird gesetzt
  }
  ...
  // createText wird hier erstellt, kommt NICHT von Phaser
  createText({
    ...
    origin
      ? textButton.setOrigin(origin[0], origin[1])
